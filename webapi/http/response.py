...
class HttpResponse(object):
    ...
    def get_status_phrase(self):
        return str(self.status) + ' ' + REASON_PHRASES.get(self.status, 'UNKNOWN STATUS CODE')
...
class NotFoundResponse(HttpResponse):
    def __init__(self, body='', headers={}):
        super(NotFoundResponse, self).__init__(body=body, status=404, headers=headers)


class NotAcceptableResponse(HttpResponse):
    def __init__(self, body='', headers={}):
